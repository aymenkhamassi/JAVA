public class AlfredTest {
    public static void main(String[] args) {
        ...
        // NINJA BONUS: Testing the angryResponse method
        String angryResponseTest = alfredBot.angryResponse("You broke the Batcomputer");
        System.out.println(angryResponseTest);
    }
}
